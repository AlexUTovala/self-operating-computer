...
- The fill color of the cursor is entirely pure red (color code: #FF0000).
- The cursor has a pure green outline (color code: #00FF00).
- The size of the cursor has been increased significantly from the standard size.
